                ...
                <div class="box box-widget">
                    <div class="box-header with-border">
                        <div class="user-block">
                            <img class="img-circle" src="${pageContext.request.contextPath}/img/user1-128x128.jpg" alt="User Image">
                            <span class="username"><a href="#">${message.user.username}</a></span>
                            <span class="description">${message.user.email}</span>
                        </div>
                        <!-- /.user-block -->
                        <div class="box-tools">
                    ...
                    <div class="box-body">
                        <div class="box-comment" id="content">
                                ${message.content}
                            </div>
