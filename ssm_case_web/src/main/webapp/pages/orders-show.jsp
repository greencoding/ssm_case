		...
		<div class="content-wrapper">
			...
			<div class="panel panel-default">
					...
					<div class="row data-type">
						...
						<div class="col-md-4 data text">${orders.user.phoneNum}</div>

						<div class="col-md-2 title">用户邮箱</div>
						<div class="col-md-4 data text">${orders.user.email}</div>

						<div class="col-md-2 title">用户状态</div>
						<div class="col-md-4 data text">${orders.user.statusStr}</div>
					</div>
				</div>
			<!--联系人信息/--> <!--费用信息-->
				<div class="panel panel-default">
